(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin_androidx_compose_animation_animation_core.js', './kotlin_androidx_compose_ui_ui_unit.js', './kotlin_kotlin.js', './kotlin_androidx_compose_ui_ui_graphics.js', './kotlin_androidx_compose_runtime_runtime.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin_androidx_compose_animation_animation_core.js'), require('./kotlin_androidx_compose_ui_ui_unit.js'), require('./kotlin_kotlin.js'), require('./kotlin_androidx_compose_ui_ui_graphics.js'), require('./kotlin_androidx_compose_runtime_runtime.js'));
  else {
    ...
    root.kotlin_androidx_compose_material_material_ripple = factory(typeof kotlin_androidx_compose_material_material_ripple === 'undefined' ? {} : kotlin_androidx_compose_material_material_ripple, kotlin_androidx_compose_animation_animation_core, kotlin_androidx_compose_ui_ui_unit, kotlin_kotlin, kotlin_androidx_compose_ui_ui_graphics, kotlin_androidx_compose_runtime_runtime);
  }
}(this, function (_, kotlin_androidx_compose_animation_animation_core, kotlin_androidx_compose_ui_ui_unit, kotlin_kotlin, kotlin_androidx_compose_ui_ui_graphics, kotlin_androidx_compose_runtime_runtime) {
