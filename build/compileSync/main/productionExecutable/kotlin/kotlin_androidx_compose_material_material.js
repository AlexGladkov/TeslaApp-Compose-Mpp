(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin_kotlin.js', './kotlin_androidx_compose_ui_ui.js', './kotlin_androidx_compose_ui_ui_unit.js', './kotlin_androidx_compose_foundation_foundation_layout.js', './kotlin_androidx_compose_animation_animation_core.js', './kotlin_androidx_compose_ui_ui_graphics.js', './kotlin_androidx_compose_runtime_runtime.js', './kotlin_androidx_compose_foundation_foundation.js', './kotlin_androidx_compose_ui_ui_text.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin_kotlin.js'), require('./kotlin_androidx_compose_ui_ui.js'), require('./kotlin_androidx_compose_ui_ui_unit.js'), require('./kotlin_androidx_compose_foundation_foundation_layout.js'), require('./kotlin_androidx_compose_animation_animation_core.js'), require('./kotlin_androidx_compose_ui_ui_graphics.js'), require('./kotlin_androidx_compose_runtime_runtime.js'), require('./kotlin_androidx_compose_foundation_foundation.js'), require('./kotlin_androidx_compose_ui_ui_text.js'));
  else {
    ...
    root.kotlin_androidx_compose_material_material = factory(typeof kotlin_androidx_compose_material_material === 'undefined' ? {} : kotlin_androidx_compose_material_material, kotlin_kotlin, kotlin_androidx_compose_ui_ui, kotlin_androidx_compose_ui_ui_unit, kotlin_androidx_compose_foundation_foundation_layout, kotlin_androidx_compose_animation_animation_core, kotlin_androidx_compose_ui_ui_graphics, kotlin_androidx_compose_runtime_runtime, kotlin_androidx_compose_foundation_foundation, kotlin_androidx_compose_ui_ui_text);
  }
}(this, function (_, kotlin_kotlin, kotlin_androidx_compose_ui_ui, kotlin_androidx_compose_ui_ui_unit, kotlin_androidx_compose_foundation_foundation_layout, kotlin_androidx_compose_animation_animation_core, kotlin_androidx_compose_ui_ui_graphics, kotlin_androidx_compose_runtime_runtime, kotlin_androidx_compose_foundation_foundation, kotlin_androidx_compose_ui_ui_text) {
  ...
  var size = kotlin_androidx_compose_foundation_foundation_layout.$crossModule$.size_1;
  ...
  var _get_sp__1413130958_0 = kotlin_androidx_compose_ui_ui_unit.$crossModule$._get_sp__1413130958_1;
  //endregion
  'use strict';
