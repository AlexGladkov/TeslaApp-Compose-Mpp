(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin_kotlin.js', './kotlin_androidx_compose_ui_ui_unit.js', './kotlin_androidx_compose_ui_ui.js', './kotlin_androidx_compose_runtime_runtime.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin_kotlin.js'), require('./kotlin_androidx_compose_ui_ui_unit.js'), require('./kotlin_androidx_compose_ui_ui.js'), require('./kotlin_androidx_compose_runtime_runtime.js'));
  else {
    ...
    if (typeof kotlin_androidx_compose_runtime_runtime === 'undefined') {
      throw new Error("Error loading module 'kotlin_androidx_compose_foundation_foundation_layout'. Its dependency 'kotlin_androidx_compose_runtime_runtime' was not found. Please, check whether 'kotlin_androidx_compose_runtime_runtime' is loaded prior to 'kotlin_androidx_compose_foundation_foundation_layout'.");
    }
    root.kotlin_androidx_compose_foundation_foundation_layout = factory(typeof kotlin_androidx_compose_foundation_foundation_layout === 'undefined' ? {} : kotlin_androidx_compose_foundation_foundation_layout, kotlin_kotlin, kotlin_androidx_compose_ui_ui_unit, kotlin_androidx_compose_ui_ui, kotlin_androidx_compose_runtime_runtime);
  }
  ...
  var Companion_getInstance = kotlin_androidx_compose_ui_ui.$crossModule$.Companion_getInstance_6;
  ...
  var Companion_getInstance_1 = kotlin_androidx_compose_ui_ui.$crossModule$.Companion_getInstance_7;
  ...
  var Companion_getInstance_2 = kotlin_androidx_compose_ui_ui.$crossModule$.Companion_getInstance_5;
  ...
  var Companion_getInstance_4 = kotlin_androidx_compose_ui_ui_unit.$crossModule$.Companion_getInstance_1;
  ...
  var Companion_getInstance_5 = kotlin_androidx_compose_ui_ui.$crossModule$.Companion_getInstance_4;
  ...
  var coerceAtMost = kotlin_kotlin.$crossModule$.coerceAtMost_1;
  ...
  var Companion_getInstance_6 = kotlin_androidx_compose_ui_ui_unit.$crossModule$.Companion_getInstance_6;
  ...
  function weight$default(_this__1828080292, weight, fill, $mask0, $handler) {
    unreachableDeclarationLog();
    if (!(($mask0 & 2) === 0))
      fill = true;
    return $handler == null ? this.weight_eps4yz_k$(_this__1828080292, weight, fill) : $handler(weight, fill);
  }
  ...
  function Column$composable(modifier, verticalArrangement, horizontalAlignment, content, $composer, $changed, $default) {
    ...
    sourceInformation($composer_0, 'C(Column$composable)P(2,3,1)');
    if (!(($default & 1) === 0))
      modifier_0 = Companion_getInstance_1();
    if (!(($default & 2) === 0))
      verticalArrangement_0 = Arrangement_getInstance()._get_Top__856463868_e5wzr0_k$();
    if (!(($default & 4) === 0))
      horizontalAlignment_0 = Companion_getInstance()._get_Start__2698618831_qefacx_k$();
    ...
    {
      var tmp0_Layout$composable_0 = modifier_0;
      var tmp1_Layout$composable_0 = $composer_0;
      var tmp2_Layout$composable_0 = 112 & $changed << 3;
      var modifier_1 = {_v: tmp0_Layout$composable_0};
      var $composer_2 = tmp1_Layout$composable_0;
      $composer_2.startReplaceableGroup_rp6air_k$(1725976829);
      sourceInformation($composer_2, 'C(Layout$composable)P(!1,2)');
      if (!(0 === 0))
        modifier_1._v = Companion_getInstance_1();
      var tmp$ret$0;
      $l$block: {
      ...
      var layoutDirection_8 = tmp$ret$1;
      var tmp$ret$2;
      $l$block_1: {
      ...
      var viewConfiguration_13 = tmp$ret$2;
      {
        var tmp6_ReusableComposeNode$composable_0_18 = Companion_getInstance_2()._get_Constructor__4117509367_2xnjex_k$();
        var tmp = $composer_2;
        var tmp7_ReusableComposeNode$composable_0_19 = composableLambda(tmp, 1410142326, true, Column$composable$lambda(modifier_1));
        var tmp8_ReusableComposeNode$composable_0_24 = $composer_2;
        var tmp9_ReusableComposeNode$composable_0_25 = 390 | 7168 & tmp2_Layout$composable_0 << 9;
        var $composer_1_26 = tmp8_ReusableComposeNode$composable_0_24;
        var tmp_0 = $composer_1_26._get_applier__3305520102_gd3aca_k$();
        if (!isInterface(tmp_0, Applier))
          invalidApplier();
        else {
        }
        $composer_1_26.startReusableNode_jk07k2_k$();
        if ($composer_1_26._get_inserting__3953988840_5n0cns_k$()) {
          $composer_1_26.createNode_13g769_k$(tmp6_ReusableComposeNode$composable_0_18);
        } else {
          $composer_1_26.useNode_inlzo8_k$();
        }
        $composer_1_26.disableReusing_y35tew_k$();
        {
          var tmp10__anonymous__3_27_3670792140 = _Updater___init__impl__2643161360($composer_1_26);
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, measurePolicy, Companion_getInstance_2()._get_SetMeasurePolicy__1635018109_r1g41p_k$());
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, density_3, Companion_getInstance_2()._get_SetDensity__2660474629_r14um3_k$());
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, layoutDirection_8, Companion_getInstance_2()._get_SetLayoutDirection__3803499288_84lv54_k$());
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, viewConfiguration_13, Companion_getInstance_2()._get_SetViewConfiguration__2455204860_ufchs4_k$());
        }
        $composer_1_26.enableReusing_6k309v_k$();
        var $invokeComposable_dispatchReceiver_2_28 = tmp7_ReusableComposeNode$composable_0_19;
        if ($invokeComposable_dispatchReceiver_2_28 instanceof ComposableLambdaImpl)
          $invokeComposable_dispatchReceiver_2_28.invoke_5qf8pc_k$(new SkippableUpdater(_SkippableUpdater___init__impl__268413021($composer_1_26)), $composer_1_26, 112 & tmp9_ReusableComposeNode$composable_0_25 >> 3);
        else {
          $invokeComposable_dispatchReceiver_2_28(new SkippableUpdater(_SkippableUpdater___init__impl__268413021($composer_1_26)), $composer_1_26, 112 & tmp9_ReusableComposeNode$composable_0_25 >> 3);
        }
        $composer_1_26.startReplaceableGroup_rp6air_k$(2058660585);
        {
          content(ColumnScopeInstance_getInstance(), $composer_0, 6 | 112 & $changed >> 6);
        }
        $composer_1_26.endReplaceableGroup_er37p7_k$();
        $composer_1_26.endNode_3mkr10_k$();
      }
  ...
  ColumnScope.$metadata$ = {
    simpleName: 'ColumnScope',
    kind: 'interface',
    interfaces: []
  };
  function columnMeasurePolicy$composable(verticalArrangement, horizontalAlignment, $composer, $changed) {
    ...
    $l$block_3: {
      ...
      var tmp1_remember$composable_0 = 14 & $changed | 112 & $changed;
      var $composer_1 = tmp0_remember$composable_0;
      $composer_1.startReplaceableGroup_rp6air_k$(-1124426577);
      sourceInformation($composer_1, 'C(remember$composable)P(1,2)');
      var tmp$ret$3;
      $l$block_2: {
        var tmp1_cache_0_3 = $composer_1;
        var tmp2_cache_0_4 = !!($composer_1.changed_ga7h3f_k$(verticalArrangement) | $composer_1.changed_ga7h3f_k$(horizontalAlignment));
        var tmp$ret$2;
        $l$block_1: {
          ...
          $l$block_0: {
            var tmp;
            if (tmp2_cache_0_4 ? true : tmp0_let_0_5 === Companion_getInstance_3()._get_Empty__2291795012_x4mxmk_k$()) {
              var tmp$ret$0;
              $l$block: {
                var tmp_0;
                if (equals(verticalArrangement, Arrangement_getInstance()._get_Top__856463868_e5wzr0_k$()) ? equals(horizontalAlignment, Companion_getInstance()._get_Start__2698618831_qefacx_k$()) : false) {
                  tmp_0 = _get_DefaultColumnMeasurePolicy__690634002();
                } else {
                  var tmp0_orientation_9 = LayoutOrientation_Vertical_getInstance();
                  var tmp1_arrangementSpacing_10 = verticalArrangement._get_spacing__4173594414_ckcwbb_k$();
                  var tmp2_crossAxisAlignment_11 = Companion_getInstance_7().horizontal_d2uuko_k$(horizontalAlignment);
                  var tmp3_crossAxisSize_12 = SizeMode_Wrap_getInstance();
                  tmp_0 = rowColumnMeasurePolicy(tmp0_orientation_9, columnMeasurePolicy$composable$lambda(verticalArrangement), tmp1_arrangementSpacing_10, tmp3_crossAxisSize_12, tmp2_crossAxisAlignment_11);
                }
                var tmp0_return_8 = tmp_0;
  ...
  function ColumnScopeInstance$weight$lambda($weight, $fill) {
    ...
    return function ($this$null) {
      $this$null._set_name__589551916_atzcdf_k$('weight');
      $this$null._set_value__1325260276_ap8xuk_k$($weight);
      $this$null._get_properties__3765791160_8r22x4_k$().set_y753qn_k$('weight', $weight);
      $this$null._get_properties__3765791160_8r22x4_k$().set_y753qn_k$('fill', $fill);
      return Unit_getInstance();
    };
  }
  function ColumnScopeInstance$align$lambda($alignment) {
    unreachableDeclarationLog();
    return function ($this$null) {
      $this$null._set_name__589551916_atzcdf_k$('align');
      $this$null._set_value__1325260276_ap8xuk_k$($alignment);
      return Unit_getInstance();
    };
  }
  function ColumnScopeInstance$alignBy$lambda($alignmentLine) {
    unreachableDeclarationLog();
    return function ($this$null) {
      $this$null._set_name__589551916_atzcdf_k$('alignBy');
      $this$null._set_value__1325260276_ap8xuk_k$($alignmentLine);
      return Unit_getInstance();
    };
  }
  function ColumnScopeInstance$alignBy$lambda_0($alignmentLineBlock) {
    ...
    return function ($this$null) {
      $this$null._set_name__589551916_atzcdf_k$('alignBy');
      $this$null._set_value__1325260276_ap8xuk_k$($alignmentLineBlock);
      return Unit_getInstance();
    };
  }
  ...
  ColumnScopeInstance.prototype.weight_eps4yz_k$ = function (_this__1828080292, weight, fill) {
    unreachableDeclarationLog();
    {
      var tmp0_require_0 = weight > 0.0;
      {
      }
      if (!tmp0_require_0) {
        var tmp$ret$0;
    ...
    return _this__1828080292.then_5qw5wu_k$(new LayoutWeightImpl(weight, fill, tmp$ret$1));
  };
  ColumnScopeInstance.prototype.align_9ddj9c_k$ = function (_this__1828080292, alignment) {
    unreachableDeclarationLog();
    var tmp$ret$0;
    $l$block: {
      var tmp;
    ...
    return _this__1828080292.then_5qw5wu_k$(new HorizontalAlignModifier(alignment, tmp$ret$0));
  };
  ColumnScopeInstance.prototype.alignBy_radkhc_k$ = function (_this__1828080292, alignmentLine) {
    unreachableDeclarationLog();
    var tmp$ret$0;
    $l$block: {
      var tmp;
    ...
    return _this__1828080292.then_5qw5wu_k$(new WithAlignmentLine(alignmentLine, tmp$ret$0));
  };
  ColumnScopeInstance.prototype.alignBy_knmuph_k$ = function (_this__1828080292, alignmentLineBlock) {
    unreachableDeclarationLog();
    var tmp$ret$0;
    $l$block: {
      var tmp;
    ...
    return _this__1828080292.then_5qw5wu_k$(new WithAlignmentLineBlock(alignmentLineBlock, tmp$ret$0));
  };
  ColumnScopeInstance.$metadata$ = {
    simpleName: 'ColumnScopeInstance',
    kind: 'object',
    interfaces: [ColumnScope]
  };
  ...
  function Column$composable$lambda($modifier_1) {
    unreachableDeclarationLog();
    return function ($extensionReceiver_androidx_compose_runtime_SkippableUpdater_1655868928, $composer, $changed) {
      var $composer_21 = $composer;
      Unit_getInstance();
      var $dirty_22 = $changed;
      Unit_getInstance();
      var tmp;
      if (($changed & 14) === 0) {
        $dirty_22 = $dirty_22 | ($composer_21.changed_ga7h3f_k$(_SkippableUpdater___get_composer__impl__3883089878($extensionReceiver_androidx_compose_runtime_SkippableUpdater_1655868928.composer_1)) ? 4 : 2);
        tmp = Unit_getInstance();
      }
      var tmp_0;
      if (!(($dirty_22 & 91) === 18) ? true : !$composer_21._get_skipping__3591855738_bmm4cm_k$()) {
        var $invokeComposable_dispatchReceiver_23 = materializerOf($modifier_1._v);
        var tmp_1;
        if ($invokeComposable_dispatchReceiver_23 instanceof ComposableLambdaImpl) {
          tmp_1 = $invokeComposable_dispatchReceiver_23.invoke_5qf8pc_k$($extensionReceiver_androidx_compose_runtime_SkippableUpdater_1655868928, $composer_21, 14 & $dirty_22);
        } else {
          {
            tmp_1 = $invokeComposable_dispatchReceiver_23($extensionReceiver_androidx_compose_runtime_SkippableUpdater_1655868928, $composer_21, 14 & $dirty_22);
          }
        }
        tmp_0 = tmp_1;
      } else {
        tmp_0 = $composer_21.skipToGroupEnd_lhns3f_k$();
      }
      return Unit_getInstance();
    };
  }
  function columnMeasurePolicy$composable$lambda($verticalArrangement) {
    return function (totalSize, size, _anonymous_parameter_2__2695192114, density, outPosition) {
      ...
      $l$block: {
        ...
        tmp$ret$0 = $verticalArrangement.arrange_bbki90_k$(density, totalSize, size, outPosition);
        break $l$block;
      }
      return Unit_getInstance();
    };
  ...
  function init_properties_Column_kt_2211406148() {
    if (!properties_initialized_Column_kt_39663976) {
      ...
      var tmp2_crossAxisAlignment = Companion_getInstance_7().horizontal_d2uuko_k$(Companion_getInstance()._get_Start__2698618831_qefacx_k$());
  ...
  LayoutScopeMarker.$metadata$ = {
    simpleName: 'LayoutScopeMarker',
    kind: 'class',
  ...
  function _get_top__857417180($this) {
    unreachableDeclarationLog();
    return $this.top_1;
  }
  function _get_right__3576132917($this) {
    unreachableDeclarationLog();
    return $this.right_1;
  }
  function _get_bottom__2354915904($this) {
    unreachableDeclarationLog();
    return $this.bottom_1;
  }
  ...
  Absolute_0.prototype.hashCode = function () {
    unreachableDeclarationLog();
    return imul(imul(imul(Dp__hashCode_impl_1749449350(this.left_1), 31) + Dp__hashCode_impl_1749449350(this.top_1) | 0, 31) + Dp__hashCode_impl_1749449350(this.right_1) | 0, 31) + Dp__hashCode_impl_1749449350(this.bottom_1) | 0;
  };
  ...
  Absolute_0.$metadata$ = {
    simpleName: 'Absolute',
    kind: 'class',
    interfaces: [PaddingValues]
  };
  function PaddingValues() {
    unreachableDeclarationLog();
  }
  PaddingValues.$metadata$ = {
  ...
  function PaddingModifier(start, top, end, bottom, rtlAware, inspectorInfo) {
    ...
    {
      var tmp0_require_0 = (((_Dp___get_value__impl__3303478217(this.start_1) >= 0.0 ? true : equals(this.start_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$())) ? _Dp___get_value__impl__3303478217(this.top_1) >= 0.0 ? true : equals(this.top_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) : false) ? _Dp___get_value__impl__3303478217(this.end_1) >= 0.0 ? true : equals(this.end_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) : false) ? _Dp___get_value__impl__3303478217(this.bottom_1) >= 0.0 ? true : equals(this.bottom_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) : false;
      {
      }
      if (!tmp0_require_0) {
        var tmp$ret$4;
  ...
  PaddingValuesImpl.prototype._get_start__3614751663_f7mfbq_k$ = function () {
    unreachableDeclarationLog();
    return this.start_1;
  };
  PaddingValuesImpl.prototype._get_top__857417180_zeh7vb_k$ = function () {
    unreachableDeclarationLog();
    return this.top_1;
  };
  PaddingValuesImpl.prototype._get_end__856968982_tuay4x_k$ = function () {
    unreachableDeclarationLog();
    return this.end_1;
  };
  PaddingValuesImpl.prototype._get_bottom__2354915904_b2yrut_k$ = function () {
    unreachableDeclarationLog();
    return this.bottom_1;
  };
  ...
  PaddingValuesImpl.prototype.hashCode = function () {
    return imul(imul(imul(Dp__hashCode_impl_1749449350(this.start_1), 31) + Dp__hashCode_impl_1749449350(this.top_1) | 0, 31) + Dp__hashCode_impl_1749449350(this.end_1) | 0, 31) + Dp__hashCode_impl_1749449350(this.bottom_1) | 0;
  };
  ...
  PaddingValuesImpl.$metadata$ = {
    simpleName: 'PaddingValuesImpl',
    kind: 'class',
    interfaces: [PaddingValues]
  };
  ...
  function calculateStartPadding(_this__1828080292, layoutDirection) {
    var tmp;
    if (layoutDirection.equals(LayoutDirection_Ltr_getInstance())) {
      tmp = _this__1828080292.calculateLeftPadding_71tp16_k$(layoutDirection);
    } else {
      tmp = _this__1828080292.calculateRightPadding_wmvkqr_k$(layoutDirection);
    }
    return tmp;
  }
  function calculateEndPadding(_this__1828080292, layoutDirection) {
    var tmp;
    if (layoutDirection.equals(LayoutDirection_Ltr_getInstance())) {
      tmp = _this__1828080292.calculateRightPadding_wmvkqr_k$(layoutDirection);
    } else {
  ...
  function init_properties_Row_kt_1754404506() {
    ...
    if (!properties_initialized_Row_kt_1713098998) {
      ...
      var tmp2_crossAxisAlignment = Companion_getInstance_7().vertical_qzmr60_k$(Companion_getInstance()._get_Top__856463868_e5wzr0_k$());
      var tmp3_crossAxisSize = SizeMode_Wrap_getInstance();
  ...
  AlignmentLineCrossAxisAlignment.prototype.align_gldapf_k$ = function (size, layoutDirection, placeable, beforeCrossAxisAlignmentLine) {
    ...
    var tmp;
    if (!(alignmentLinePosition === Companion_getInstance_5()._get_Unspecified__2946689370_maq9wm_k$())) {
  ...
  LayoutWeightImpl.prototype._get_weight__3515779987_cvworx_k$ = function () {
    unreachableDeclarationLog();
    return this.weight_1;
  };
  LayoutWeightImpl.prototype._get_fill__797018408_d6ivc8_k$ = function () {
    unreachableDeclarationLog();
    return this.fill_1;
  };
  LayoutWeightImpl.prototype.modifyParentData_x7ztp7_k$ = function (_this__1828080292, parentData) {
    unreachableDeclarationLog();
    var tmp$ret$0;
    $l$block: {
      ...
      {
        tmp0_also_0.weight_1 = this.weight_1;
        tmp0_also_0.fill_1 = this.fill_1;
      }
  ...
  LayoutWeightImpl.$metadata$ = {
    simpleName: 'LayoutWeightImpl',
    kind: 'class',
    interfaces: [ParentDataModifier]
  };
  ...
  HorizontalAlignModifier.prototype._get_horizontal__2475509991_u39a8p_k$ = function () {
    unreachableDeclarationLog();
    return this.horizontal_1;
  };
  HorizontalAlignModifier.prototype.modifyParentData_x7ztp7_k$ = function (_this__1828080292, parentData) {
    unreachableDeclarationLog();
    var tmp$ret$0;
    $l$block: {
      var tmp0_elvis_lhs = parentData instanceof RowColumnParentData ? parentData : null;
      ...
      {
        tmp0_also_0.crossAxisAlignment_1 = Companion_getInstance_7().horizontal_d2uuko_k$(this.horizontal_1);
      }
      tmp$ret$0 = tmp0_also_0;
      break $l$block;
    }
  ...
  HorizontalAlignModifier.$metadata$ = {
    simpleName: 'HorizontalAlignModifier',
    kind: 'class',
    interfaces: [ParentDataModifier]
  };
  ...
  WithAlignmentLineBlock.prototype._get_block__3121070308_jewopo_k$ = function () {
    unreachableDeclarationLog();
    return this.block_1;
  };
  WithAlignmentLineBlock.prototype.modifyParentData_x7ztp7_k$ = function (_this__1828080292, parentData) {
    unreachableDeclarationLog();
    var tmp$ret$0;
    $l$block: {
      var tmp0_elvis_lhs = parentData instanceof RowColumnParentData ? parentData : null;
      ...
      {
        tmp0_also_0.crossAxisAlignment_1 = Companion_getInstance_7().Relative_767dzl_k$(new Block(this.block_1));
      }
      tmp$ret$0 = tmp0_also_0;
      break $l$block;
    }
  ...
  WithAlignmentLineBlock.$metadata$ = {
    simpleName: 'WithAlignmentLineBlock',
    kind: 'class',
    interfaces: []
  };
  ...
  WithAlignmentLine.prototype._get_alignmentLine__4249428794_r41qe_k$ = function () {
    unreachableDeclarationLog();
    return this.alignmentLine_1;
  };
  WithAlignmentLine.prototype.modifyParentData_x7ztp7_k$ = function (_this__1828080292, parentData) {
    unreachableDeclarationLog();
    var tmp$ret$0;
    $l$block: {
      var tmp0_elvis_lhs = parentData instanceof RowColumnParentData ? parentData : null;
      ...
      {
        tmp0_also_0.crossAxisAlignment_1 = Companion_getInstance_7().Relative_767dzl_k$(new Value(this.alignmentLine_1));
      }
      tmp$ret$0 = tmp0_also_0;
      break $l$block;
    }
  ...
  WithAlignmentLine.$metadata$ = {
    simpleName: 'WithAlignmentLine',
    kind: 'class',
    interfaces: []
  };
  ...
  SiblingsAlignedModifier.$metadata$ = {
    simpleName: 'SiblingsAlignedModifier',
    kind: 'class',
    interfaces: [ParentDataModifier]
  };
          ...
          if (!(alignmentLinePosition == null)) {
            ...
            $l$block_13: {
              ...
              $l$block_12: {
                ...
                var tmp$ret$12;
                $l$block_11: {
                  tmp$ret$12 = !(alignmentLinePosition === Companion_getInstance_5()._get_Unspecified__2946689370_maq9wm_k$()) ? alignmentLinePosition : 0;
                  break $l$block_11;
                }
  ...
  function heightIn$default(_this__1828080292, min, max, $mask0, $handler) {
    unreachableDeclarationLog();
    if (!(($mask0 & 1) === 0))
      min = Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$();
    if (!(($mask0 & 2) === 0))
      max = Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$();
  ...
  function defaultMinSize$default(_this__1828080292, minWidth, minHeight, $mask0, $handler) {
    unreachableDeclarationLog();
    if (!(($mask0 & 1) === 0))
      minWidth = Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$();
    if (!(($mask0 & 2) === 0))
      minHeight = Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$();
    return defaultMinSize(_this__1828080292, minWidth, minHeight);
  }
  function height(_this__1828080292, height) {
    init_properties_Size_kt_3567011193();
    var tmp$ret$0;
    $l$block: {
      var tmp;
    ...
    return _this__1828080292.then_5qw5wu_k$(SizeModifier_init_$Create$(null, height, null, height, true, tmp$ret$0, 5, null));
  }
  function SizeModifier_init_$Init$(minWidth, minHeight, maxWidth, maxHeight, enforceIncoming, inspectorInfo, $mask0, $marker, $this) {
    ...
    if (!(($mask0 & 2) === 0))
      minHeight = Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$();
    if (!(($mask0 & 4) === 0))
      maxWidth = Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$();
    if (!(($mask0 & 8) === 0))
      maxHeight = Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$();
  ...
  function _get_targetConstraints__1973896204(_this__1828080292, $this) {
    var tmp;
    if (!equals($this.maxWidth_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$())) {
    ...
    var maxWidth = tmp;
    var tmp_1;
    if (!equals($this.maxHeight_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$())) {
    ...
    var maxHeight = tmp_1;
    var tmp_3;
    if (!equals($this.minWidth_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$())) {
      var tmp$ret$3;
      $l$block_2: {
    ...
    var minWidth = tmp_3;
    var tmp_4;
    if (!equals($this.minHeight_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$())) {
      var tmp$ret$5;
      $l$block_4: {
  ...
  UnspecifiedConstraintsModifier.prototype.measure_i9wrw7_k$ = function (_this__1828080292, measurable, constraints) {
    unreachableDeclarationLog();
    var tmp;
    if (!equals(this.minWidth_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) ? _Constraints___get_minWidth__impl__3236361538(constraints) === 0 : false) {
    ...
    var tmp_2;
    if (!equals(this.minHeight_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) ? _Constraints___get_minHeight__impl__3396171247(constraints) === 0 : false) {
  ...
  UnspecifiedConstraintsModifier.prototype.minIntrinsicWidth_72od57_k$ = function (_this__1828080292, measurable, height) {
    unreachableDeclarationLog();
    return coerceAtLeast_0(measurable.minIntrinsicWidth_3wv0r6_k$(height), !equals(this.minWidth_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) ? _this__1828080292.roundToPx_hl1u8z_k$(this.minWidth_1) : 0);
  };
  UnspecifiedConstraintsModifier.prototype.maxIntrinsicWidth_o2xntp_k$ = function (_this__1828080292, measurable, height) {
    unreachableDeclarationLog();
    return coerceAtLeast_0(measurable.maxIntrinsicWidth_g1vwkc_k$(height), !equals(this.minWidth_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) ? _this__1828080292.roundToPx_hl1u8z_k$(this.minWidth_1) : 0);
  };
  UnspecifiedConstraintsModifier.prototype.minIntrinsicHeight_zr6pa_k$ = function (_this__1828080292, measurable, width) {
    unreachableDeclarationLog();
    return coerceAtLeast_0(measurable.minIntrinsicHeight_7ydhpj_k$(width), !equals(this.minHeight_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) ? _this__1828080292.roundToPx_hl1u8z_k$(this.minHeight_1) : 0);
  };
  UnspecifiedConstraintsModifier.prototype.maxIntrinsicHeight_t0gmkg_k$ = function (_this__1828080292, measurable, width) {
    unreachableDeclarationLog();
    return coerceAtLeast_0(measurable.maxIntrinsicHeight_cegb5z_k$(width), !equals(this.minHeight_1, Companion_getInstance_4()._get_Unspecified__2946689370_rvxoyd_k$()) ? _this__1828080292.roundToPx_hl1u8z_k$(this.minHeight_1) : 0);
  };
  ...
  function size_0(_this__1828080292, width, height) {
    unreachableDeclarationLog();
    init_properties_Size_kt_3567011193();
    var tmp$ret$0;
    $l$block: {
    ...
    var tmp0_inspectorInfo = tmp$ret$0;
    return _this__1828080292.then_5qw5wu_k$(new SizeModifier(width, height, width, height, true, tmp0_inspectorInfo));
  }
  ...
  function createWrapContentSizeModifier$lambda($align) {
    return function (size, layoutDirection) {
      return new IntOffset_0($align.align_f85h4l_k$(Companion_getInstance_6()._get_Zero__785822851_4arau6_k$(), size.packedValue_1, layoutDirection));
    };
  }
  ...
  function height$lambda($height) {
    return function ($this$null) {
      $this$null._set_name__589551916_atzcdf_k$('height');
      $this$null._set_value__1325260276_ap8xuk_k$(new Dp($height));
      return Unit_getInstance();
    };
  }
  function size$lambda_0($width, $height) {
    ...
    return function ($this$null) {
      $this$null._set_name__589551916_atzcdf_k$('size');
      $this$null._get_properties__3765791160_8r22x4_k$().set_y753qn_k$('width', new Dp($width));
      $this$null._get_properties__3765791160_8r22x4_k$().set_y753qn_k$('height', new Dp($height));
      return Unit_getInstance();
    };
  }
  ...
  function Spacer$composable(modifier, $composer, $changed) {
    ...
    {
      var tmp0_Layout$composable_0 = $composer_0;
      var tmp1_Layout$composable_0 = 384 | 112 & $changed << 3;
      var modifier_1 = {_v: modifier};
      var $composer_2 = tmp0_Layout$composable_0;
      $composer_2.startReplaceableGroup_rp6air_k$(1725976829);
      sourceInformation($composer_2, 'C(Layout$composable)P(!1,2)');
      if (!(0 === 0))
        modifier_1._v = Companion_getInstance_1();
      ...
      var viewConfiguration_13 = tmp$ret$2;
      {
        var tmp6_ReusableComposeNode$composable_0_18 = Companion_getInstance_2()._get_Constructor__4117509367_2xnjex_k$();
        var tmp = $composer_2;
        var tmp7_ReusableComposeNode$composable_0_19 = composableLambda(tmp, 1410142326, true, Spacer$composable$lambda(modifier_1));
        var tmp8_ReusableComposeNode$composable_0_24 = $composer_2;
        var tmp9_ReusableComposeNode$composable_0_25 = 390 | 7168 & tmp1_Layout$composable_0 << 9;
        var $composer_1_26 = tmp8_ReusableComposeNode$composable_0_24;
        var tmp_0 = $composer_1_26._get_applier__3305520102_gd3aca_k$();
        if (!isInterface(tmp_0, Applier))
          invalidApplier();
        ...
        {
          var tmp10__anonymous__3_27_3670792140 = _Updater___init__impl__2643161360($composer_1_26);
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, tmp0_measurePolicy, Companion_getInstance_2()._get_SetMeasurePolicy__1635018109_r1g41p_k$());
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, density_3, Companion_getInstance_2()._get_SetDensity__2660474629_r14um3_k$());
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, layoutDirection_8, Companion_getInstance_2()._get_SetLayoutDirection__3803499288_84lv54_k$());
          Updater__set_impl_2407782900(tmp10__anonymous__3_27_3670792140, viewConfiguration_13, Companion_getInstance_2()._get_SetViewConfiguration__2455204860_ufchs4_k$());
        }
  ...
  function SpacerMeasurePolicy$measure$lambda() {
    return function ($this$layout) {
      return Unit_getInstance();
    };
  }
  ...
  SpacerMeasurePolicy.prototype.measure_i7pm3b_k$ = function (_this__1828080292, measurables, constraints) {
    var tmp$ret$1;
    $l$block_0: {
      {
      }
      var tmp$ret$0;
      $l$block: {
        var width_2 = _Constraints___get_hasFixedWidth__impl__283911996(constraints) ? _Constraints___get_maxWidth__impl__51833172(constraints) : 0;
        var height_3 = _Constraints___get_hasFixedHeight__impl__2064548661(constraints) ? _Constraints___get_maxHeight__impl__3460039709(constraints) : 0;
        tmp$ret$0 = _this__1828080292.layout$default_yb6zmd_k$(width_2, height_3, null, SpacerMeasurePolicy$measure$lambda(), 4, null);
        break $l$block;
      }
      tmp$ret$1 = tmp$ret$0;
      break $l$block_0;
  ...
  SpacerMeasurePolicy.$metadata$ = {
    simpleName: 'SpacerMeasurePolicy',
    kind: 'object',
    interfaces: [MeasurePolicy]
  };
  ...
  function Spacer$composable$lambda($modifier_1) {
    return function ($extensionReceiver_androidx_compose_runtime_SkippableUpdater_1655868928, $composer, $changed) {
      var $composer_21 = $composer;
      Unit_getInstance();
      var $dirty_22 = $changed;
  ...
  _.$crossModule$.PaddingValues = PaddingValues_1;
  _.$crossModule$.PaddingValues_1 = PaddingValues_0;
  _.$crossModule$.Spacer$composable = Spacer$composable;
  _.$crossModule$.calculateEndPadding = calculateEndPadding;
  _.$crossModule$.calculateStartPadding = calculateStartPadding;
  _.$crossModule$.columnMeasurePolicy$composable = columnMeasurePolicy$composable;
  _.$crossModule$.defaultMinSize = defaultMinSize;
  _.$crossModule$.height = height;
  ...
  _.$crossModule$.Arrangement_getInstance = Arrangement_getInstance;
  _.$crossModule$.ColumnScopeInstance_getInstance = ColumnScopeInstance_getInstance;
  //endregion
  return _;
}));
